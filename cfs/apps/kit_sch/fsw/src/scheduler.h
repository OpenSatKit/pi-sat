...
#define SCHEDULER_SEND_MSG_EVENT_MSG_TYPE_ERR_EID    (SCHEDULER_BASE_EID + 13)
...
} SCHEDULER_ConfigSchEntryCmdMsg;
...
*/
const MSGTBL_Tbl* SCHEDULER_GetMsgTblPtr(void);
...
*/
const SCHTBL_Tbl* SCHEDULER_GetSchTblPtr(void);
